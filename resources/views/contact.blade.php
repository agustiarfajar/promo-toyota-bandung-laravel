<section id="contactsection">
    <div class="relative flex items-center justify-center p-4">
        <h1 class="bg-green-500 font-bold h-1 w-auto rounded-xl text-4xl">KONTAK</h1>
    </div>
    <div class="p-10 text-white">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 shadow-4xl bg-gray-100 text-black rounded-lg">
                <div class="flex m-5 items-center justify-center">
                    <div class="w-full">
                        <div class="w-3/4 h-auto overflow-hidden mx-auto">
                            <img src="{{ asset('images/pp.png') }}" alt="Profile">
                        </div>
                    </div>
                </div>

                <div class="m-5 items-center justify-center">
                    <p class="font-semibold">Info Promo Toyota Bandung dan Jabar (Jawa Barat), Hubungi Sales Resmi Toyota Bandung kami :</p>
                    <p class="text-4xl font-bold pb-3 pt-9">Sanudin Hasan</p>
                    <p class="font-semibold"><strong>Telepon :</strong> 0812-7501-3477</p>
                    <p class="font-semibold"><strong>Whatsapp :</strong> 0812-7501-3477</p>

                    <div class="flex w-full h-24 pt-5">
                        <a href="https://wa.me/6281275013477?text=Halo%20Pak%20Hasan%2C%0ASaya%20mau%20beli%20Mobil%20Toyota.%0A%E2%80%A2%20Nama%20%3A%20%0A%E2%80%A2%20Pembelian%20%3A%20Credit%2FCash%0A%E2%80%A2%20Unit%20%3A%20%0A%E2%80%A2%20Estimasi%C2%A0Budget%C2%A0DP%C2%A0%3A" class="text-white shadow-xl flex items-center justify-center p-3 rounded bg-green-500 hover:bg-green-600 hover:shadow-2xl transition h-14 w-auto duration-500">
                            ...
                            <p class="px-2">Klik Untuk Menghubungi Sales</p>
                        </a>
                    </div>

                </div>

                <div class="p-5 m-5 items-center justify-center rounded border-2 border-solid border-black text-sm">
                    <p class="font-semibold">Hal yang paling utama bagi kami adalah kepuasan Customer. Kami akan memberikan pelayanan yang terbaik, fast response, proses kredit cepat, data aplikasi di bantu dan memberikan Pelayanan 24 Jam sedekat sahabat serta sehangat keluarga.
                    </p>
                    <p class="font-semibold pt-5">Segera dapatkan Promo Toyota Bandung Terbaik, terlengkap dan termurah serta Bonus-bonus menarik. Dapatkan Fasilitas Dealer yang lengkap dan nyaman, Harga mobil baru termurah, Diskon/Cashback terbesar. <a href="https://drive.google.com/drive/folders/1jI22YqfwSIGtrusOQ8-c9pCDv4M9e6EB" class="text-blue-500 hover:text-blue-900 underline">Download E-Katalog/Brosur Digital</a> dan Daftar Harga OTR/Price List Toyota, Tabel Paket Simulasi Kredit DP Minim/Rendah, Cicilan/Angsuran Ringan/Murah.</p>
                </div>
